...
$$R(p) = \frac{Q(p/2)}{Q(1-p/2)}, \quad  \leq p \leq 1.$$
$R(p)$ in a non-decreasing function between 0 and 1, which takes value 1 for any $0 \leq p \leq 1$ when income (or another economic variable with poisitive support) is equally distributed among the individuals.
